...
const Hero = () => {
    return (
        <section id="home" className="sm:w-70 sm:h-50 sm:mt-28 md:h-[576px] md:w-[1024px] lg:w-[1360px] lg:h-[765px] flex flex-col mx-auto justify-center items-center text-center px-6 mt-12 bg-gradient-to-tr from-indigo-900 via-purple-900 to-pink-900 text-white">
            {/*
