...
const Hero = () => {
    return (
        <section id="home" className="min-h-210 flex flex-col justify-center items-center text-center px-6 pt-32 bg-gradient-to-tr from-indigo-900 via-purple-900 to-pink-900 text-white">
