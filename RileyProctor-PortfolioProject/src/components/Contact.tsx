...
function Contact() {
    ...
    return (
        <section id="contact" className="bg-gray-900 shadow-lg shadow-lightacc2 outline-solid outline-lightacc2 rounded-xl dark:bg-darkbgsec dark:shadow-darkbglight/50  dark:outline-darkbglight text-white py-19 max-w-225 mx-auto h-fit text-center">
            ...
            <form onSubmit={sendEmail} className="max-w-md mx-auto space-y-4 text-left">
                ...
                <button type="submit" className="w-full bg-blue-600 hover:bg-lightbutton hover:text-black dark:bg-darkbg hover:bg-blue-700 dark:hover:bg-darklightsec dark:hover:text-white transition-colors text-white font-semibold py-2 px-4 rounded">
                    Send Message
                </button>
            </form>
